...
function Home() {
  return (
    <div className="h-screen bg-cover bg-center bg-[url(/home/alvin/development/code/phase-2/Project/recipe-book2/src/assets/image1.jpg)] flex flex-col items-center ">
